...
.cc-chip{display:inline-flex;align-items:center;gap:5px;height:22px;padding:0 8px;font-size:var(--text-sm);font-weight:600;font-family:var(--font-mono);color:var(--foreground);border-radius:2px;white-space:nowrap}
.cc-st-dot{width:6px;height:6px;border-radius:50%;flex-shrink:0}
.cc-st-pill{display:inline-flex;align-items:center;gap:4px;height:18px;padding:0 7px;border-radius:2px;font-size:var(--text-xs);font-weight:600;white-space:nowrap;flex-shrink:0}
.cc-more{font-size:var(--text-xs);font-weight:600;color:var(--muted)}
.cc-pj{display:inline-flex;align-items:center;justify-content:center;min-width:24px;height:16px;padding:0 4px;border-radius:2px;font-size:var(--text-micro);font-weight:700;font-family:var(--font-mono);color:var(--accent-foreground);letter-spacing:.02em;flex-shrink:0}
.cc-empty{display:inline-flex;align-items:center;gap:5px;font-size:var(--text-sm);color:var(--muted);opacity:0;transition:opacity .12s}
:global(.lv-row:hover) .cc-empty{opacity:1}
.cc-panel{padding:8px;min-width:300px}
.cc-search{width:100%;height:30px;font-size:var(--text-sm);padding:0 8px;font-family:inherit;color:var(--foreground);outline:none}
...
.cc-result-key{font-size:var(--text-xs);font-weight:600;font-family:var(--font-mono);color:var(--muted);flex-shrink:0}
.cc-result-title{font-size:var(--text-sm);color:var(--foreground);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.cc-note{font-size:var(--text-sm);color:var(--muted);padding:8px;text-align:center}
.cc-sep{height:1px;background:var(--separator);margin:8px 0 6px}
.cc-hdr{font-size:var(--text-xs);font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:.05em;margin:0 0 4px;padding:0 2px}
...
.cc-linked-label{flex:1;font-size:var(--text-sm);color:var(--foreground);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
