...
.bc-chip{display:inline-flex;align-items:center;gap:5px;height:22px;padding:0 8px;font-size:11.5px;font-weight:500;font-family:var(--font-mono);color:var(--foreground);background:var(--surface-secondary);border-radius:2px;white-space:nowrap}
.bc-more{font-size:11px;color:var(--muted)}
.bc-dot{width:7px;height:7px;border-radius:50%;flex-shrink:0}
.bc-empty{display:inline-flex;align-items:center;gap:5px;font-size:12px;color:var(--muted);opacity:0;transition:opacity .12s}
:global(.lv-row:hover) .bc-empty{opacity:1}
.bc-panel{padding:8px;min-width:260px}
.bc-search{width:100%;height:30px;font-size:12.5px;padding:0 8px;font-family:inherit;color:var(--foreground);outline:none}
...
.bc-result-key{font-size:11px;font-weight:600;font-family:var(--font-mono);color:var(--muted);flex-shrink:0}
.bc-result-title{font-size:12.5px;color:var(--foreground);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.bc-note{font-size:12px;color:var(--muted);padding:8px;text-align:center}
.bc-sep{height:1px;background:var(--separator);margin:8px 0 6px}
.bc-hdr{font-size:10.5px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:.05em;margin:0 0 4px;padding:0 2px}
...
.bc-linked-label{flex:1;font-size:12.5px;color:var(--foreground);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
