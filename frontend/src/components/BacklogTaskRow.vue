...
.bl-issue-key { font-size:var(--text-xs); font-weight: 700; color: var(--muted); font-family: monospace; white-space: nowrap; }
.bl-issue-type { width: 15px; height: 15px; border-radius: 2px; flex-shrink: 0; display: inline-flex; align-items: center; justify-content: center; color: var(--accent-foreground); font-size:var(--text-micro); font-weight: 700; }
.bl-issue-title { font-size:var(--text-base); color: var(--foreground); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; flex-shrink: 1; min-width: 24px; }
.bl-lbl-chip { flex-shrink: 0; padding: 1px 6px; border: 1px solid; border-radius: 3px; font-size:var(--text-xs); font-weight: 600; white-space: nowrap; }
.bl-erp-badge { flex-shrink: 0; height: 16px; padding: 0 5px; font-size:var(--text-micro); font-weight: 700; letter-spacing: .02em; color: var(--accent-soft-foreground); background: var(--accent-soft); border: none; border-radius: 3px; cursor: pointer; }
.bl-billable-badge { flex-shrink: 0; display: inline-flex; align-items: center; justify-content: center; width: 16px; height: 16px; font-size:var(--text-micro); font-weight: 800; color: var(--success-soft-foreground); background: var(--success-soft); border-radius: 3px; }
.bl-mirror-chip { flex-shrink: 0; max-width: 130px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; height: 16px; padding: 0 6px; font-size:var(--text-micro); font-weight: 600; color: var(--muted); background: var(--surface-secondary); border: none; border-radius: 3px; cursor: pointer; }
.bl-issue-status { flex-shrink: 0; padding: 2px 7px; font-size:var(--text-xs); font-weight: 700; text-transform: uppercase; letter-spacing: .04em; border: 1px solid; border-radius: 3px; white-space: nowrap; }
.bl-issue-assignees { display: flex; flex-shrink: 0; justify-content: flex-end; }
.bl-av { width: 20px; height: 20px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; color: var(--accent-foreground); font-size:var(--text-micro); font-weight: 700; margin-left: -4px; border: 1.5px solid var(--surface); flex-shrink: 0; }
...
.bl-col-text { font-size:var(--text-sm); color: var(--muted); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.bl-col-input {
