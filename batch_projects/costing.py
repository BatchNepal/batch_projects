...
──────────────────────────
Single source of truth for "what did this labour actually cost", shared by
the Money tab (api/erp_link.py get_project_money) and the Margin Report
(api/board.py get_margin_report).
