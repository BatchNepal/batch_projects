...
class TestTrashBoundaryEnforcement(FrappeTestCase):
    ...
    def test_guest_comment_on_trashed_task_rejected(self, get_value):
    ...
    @patch.object(sharing.frappe.db, "get_value")
    def test_guest_update_shared_task_rejects_trashed(self, get_value):
...
class TestSeatCapacityAndTeamREST(FrappeTestCase):
    ...
    def test_project_member_addition_checks_seats(self, assert_seats):
        ...
        pdoc.append("members", {"user": user, "role": "Developer"})
    ...
    def test_team_validate_checks_new_member_seats(self, assert_seats):
        ...
        tdoc.append("members", {"user": user, "role": "Developer"})
...
class TestScheduleDataIntegrity(FrappeTestCase):
    ...
    def test_query_tasks_by_date_filters_trash(self, get_all):
        ...
        automation_schedule_data.query_tasks_by_date("2026-09-01", "2026-09-30")
    ...
    def test_apply_task_occurrence_uses_for_update(self, sql):
        ...
        sql.return_value = [[
            task, proj, "Title", "To Do", 0, 1, None, None, None, None, None, 0
        ]]
